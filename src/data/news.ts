...
export const newsData: Post[] = [
  {
    ...
    description: "태일씨앤티가 지난 3월 23일 삼성물산 건설부문으로부터 '25년도 시공능력평가 우수업체'로 선정되어 최우수상을 수상했습니다.",
    content: `
  ...
  },
  {
    ...
    description: "계열사 태경이노베이션이 금천구청에서 지역 내 모범 청소년들을 위한 장학금 전달식을 진행했습니다.",
    content: `
  ...
  },
  {
    ...
    description: "김경수 대표이사가 지난 12월 9일 (사)한국산업단지경영자연합회 서울(KIBA 서울) 제6대 회장으로 취임했습니다.",
    content: `
    ...
    `,
    detailImages: [
      "/assets/news/news3_detail1.jpg",
      "/assets/news/news3_detail2.jpg"
    ]
  },
  {
    id: 4,
    ...
    date: "2025-11-20",
    imageUrl: "/assets/news/news1.jpg",
    description: "전 현장의 안전 의식을 고취하고 우수 사례를 공유하기 위한 안전보건 경영 워크숍을 진행했습니다.",
    content: `
  ...
  },
  {
    ...
    date: "2025-10-15",
    imageUrl: "/assets/news/news2.jpg",
    description: "지속적인 사회공헌 활동과 지역 인프라 개선 노력을 인정받아 지자체로부터 표창을 수상했습니다.",
    content: `
