    ...
    <div className="animate-fade-in-up space-y-32">
          ...
          <div className="flex-1 p-12 md:p-16 border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-col justify-center bg-white">
             ...
             <div className="flex items-center justify-around gap-4">
                <div className="text-center group flex-1">
                   <div className="w-24 h-24 rounded-full bg-gray-50 flex items-center justify-center mb-6 mx-auto group-hover:bg-green-50 transition-all duration-300 group-hover:scale-105 shadow-sm">
                   ...
                   <p className="text-[14px] text-gray-600 font-medium leading-relaxed">연간 성과 및<br/>목표 달성도 측정</p>
                </div>
                ...
                <div className="text-center group flex-1">
                   ...
                   <p className="text-[14px] text-gray-600 font-medium leading-relaxed">직무별 공통 및<br/>전문 역량 진단</p>
                </div>
             </div>
          </div>
          ...
          <div className="flex-1 p-8 md:p-12 bg-gray-50/50 flex flex-col justify-center">
             ...
             <div className="grid gap-5">
                {[
                  ...
                  <div key={item.id} className="flex items-center p-6 bg-white rounded-xl border border-gray-100 shadow-sm hover:border-green-200 hover:shadow-md transition-all duration-300 group">
      ...
      <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
           <div className="bg-white border border-gray-100 hover:border-green-200 rounded-2xl p-10 flex flex-col items-center text-center shadow-[0_2px_10px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_20px_rgba(0,160,0,0.08)] transition-all duration-300 group relative overflow-hidden">
           ...
           <div className="bg-white border border-gray-100 hover:border-green-200 rounded-2xl p-10 flex flex-col items-center text-center shadow-[0_2px_10px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_20px_rgba(0,160,0,0.08)] transition-all duration-300 group relative overflow-hidden">
              ...
              <p className="text-gray-700 font-medium leading-relaxed">(현장수당, 자격증수당,<br/>특근수당, 기타 수당 등)</p>
           </div>
