...
export default function ESG() {
  ...
  const sideMenuItems = [
    { name: 'ESG', desc: '더 나은 내일을 건설하는 태일씨앤티의 지속가능 경영 비전입니다.' },
    { name: '환경경영', desc: '자연과 인간이 조화로운 건설 환경을 조성합니다.' },
    { name: '윤리경영', desc: '정직과 신뢰를 바탕으로 깨끗하고 투명한 기업 문화를 정착시킵니다.' },
  ];
          ...
          <div className="space-y-16">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
              <div className="bg-green-50 p-8 md:p-12 rounded-3xl border border-green-100">
                ...
                <p className="text-xl text-gray-700 leading-relaxed font-light break-keep">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-10 bg-zinc-50 rounded-3xl border border-zinc-100 space-y-6">
                  ...
                  <ul className="space-y-4 text-[18px] text-gray-600 font-light">
                ...
                <div className="p-10 bg-green-900 text-white rounded-3xl space-y-6">
                  ...
                  <p className="text-lg leading-relaxed opacity-90 font-light break-keep">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="flex-1 space-y-8">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed font-light break-keep">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                <div className="p-8 border-l-4 border-green-700 bg-white shadow-sm space-y-4">
                  ...
                  <p className="text-gray-500 font-light leading-relaxed">어떠한 형태의 부정 청탁이나 향응 수수를 금지하며 공정한 거래 질서를 확립합니다.</p>
                </div>
                <div className="p-8 border-l-4 border-blue-700 bg-white shadow-sm space-y-4">
                  ...
                  <p className="text-gray-500 font-light leading-relaxed">협력사와의 수평적 관계를 유지하고 기술 지원 및 상생 협력을 통해 함께 성장합니다.</p>
                </div>
              </div>
            </motion.div>
          </div>
